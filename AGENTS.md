# Agent Instructions for PiiRedactor

## Project Context
PiiRedactor is an open source Automatic PII detection and redaction in agent telemetry.

## Repository Layout
- `src/aumai_pii_redactor/` — package source
